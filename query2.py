...
if __name__ == '__main__':
    ...
    query.compute_bow_features(query_img, queryfile, nearest_ids, closest_dists)

    query.compute_tfidf_features(queryfile, nearest_ids, closest_dists)

    query.compute_baseline_features(queryfile, nearest_ids, closest_dists)
